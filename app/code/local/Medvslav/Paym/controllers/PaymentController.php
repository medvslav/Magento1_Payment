 ...
 * @author      Medvslav
 */
class Medvslav_Paym_PaymentController extends Mage_Core_Controller_Front_Action
{
 /**
  ...
  */ 
  public function gatewayAction() 
  {
    if ($this->getRequest()->get("orderId"))
    {
      ...
      Mage_Core_Controller_Varien_Action::_redirect('mypaymentmethod/payment/response', array('_secure' => false, '_query'=> $arr_querystring));
    }
  }
  ...
  */    
  ...
  {
    $this->loadLayout();
    $block = $this->getLayout()->createBlock('Mage_Core_Block_Template','medvslav_paym',array('template' => 'medvslav_paym/redirect.phtml'));
